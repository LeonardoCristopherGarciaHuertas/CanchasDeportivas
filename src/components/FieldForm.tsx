  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: '#1976d2', fontWeight: 700, fontSize: 26, marginBottom: 24, letterSpacing: 1 }}>{initialData ? 'Editar Cancha' : 'Agregar Cancha'}</h2>
        <input
          type="text"
          placeholder="Nombre"
          value={nombre}
        ...
        <textarea
          ...
          style={{ marginBottom: 14, width: '100%', padding: 10, borderRadius: 7, border: '1px solid #b0bec5', fontSize: 16, background: '#f7fafd', outline: 'none', minHeight: 60, resize: 'vertical' }}
        />
